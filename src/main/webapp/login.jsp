...
<head>
    ...
    <title>学生管理系统（WWW.YLCTO.CN）</title>
                    ...
                    <form role="form" action="<%=basePath%>pages/back/admin_login.action" method="post" id="loginForm">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" placeholder="E-mail" name="email" type="email" autofocus value="1224865593@qq.com">
                            </div>
                            <div class="form-group">
...
<script src="WEB-INF/js/metisMenu/metisMenu.min.js"></script>
